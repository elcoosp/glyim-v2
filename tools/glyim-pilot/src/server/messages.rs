...
pub enum ExtensionMessage {
    ...
    #[serde(rename = "pong")] Pong { timestamp: u64, v: u32 },
}
...
impl ExtensionMessage {
    ...
    pub fn validate_version(&self) -> Result<(), String> {
        let v = self.version();
        if v == 0 { return Err(format!("message with v=0 rejected (current: {})", PROTOCOL_VERSION)); }
        Ok(())
    }
}
...
pub enum CliMessage {
    ...
    #[serde(rename = "ping")] Ping { timestamp: u64, v: u32 },
}
