...
use crate::gates::{
    architecture::ArchitectureGate, banned_pattern::BannedPatternGate, check::CheckGate,
    clippy::ClippyGate, contracts::ContractGate, fmt_check::FmtCheckGate, test::TestGate, Gate,
    PipelineResult,
};
use std::sync::Arc;
