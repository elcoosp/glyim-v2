# Stream W1-C02: Enum downcast projection

## Mission
Implement Make `ProjectionElem::Downcast` a no-op in codegen. No pointer adjustment; only change type view for subsequent field projections. for the Glyim compiler.
