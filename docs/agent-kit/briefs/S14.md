...
- glyim_typeck::TypeckCtx, Adjustment, AdjustKind
- glyim_typeck::thir (Body, Param, Stmt, Expr, ExprKind, Pattern, PatternKind, Literal, LocalVarId)
- glyim_type::TyCtxMut, TyCtx, Ty, TyKind
- glyim_type::InferVar, Region, Substitution
- glyim_solve::InferenceTable, TraitSolver, SolverResult
- glyim_solve::FulfillmentCtx, Obligation, ObligationCause
- glyim_hir::CrateHir
