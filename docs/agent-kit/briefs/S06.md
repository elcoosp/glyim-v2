...
- glyim_mir::TerminatorKind (Goto, SwitchInt, Return, Unreachable, Call, Assert, Drop)
- glyim_mir::StatementKind (Assign, StorageLive, StorageDead, Nop)
- glyim_mir::Rvalue (Use, BinaryOp, UnaryOp, Ref, Aggregate, Discriminant, Len, Cast, Repeat)
- glyim_mir::Operand (Copy, Move, Constant), Place, LocalDecl, MirConst
- glyim_mir::BorrowKind (Shared, Unique, Mut)
- glyim_mir::SwitchTargets, SourceInfo, MirConstKind
- glyim_mir::BasicBlockIdx, LocalIdx, VariantIdx
