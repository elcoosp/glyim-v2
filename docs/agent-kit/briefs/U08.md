# Stream SU08: LSP Server – Advanced Features

## Mission
Implement Implement remaining LSP stubs: `code_action`, `folding_ranges`, `format_document`, `rename`. Also implement `provide_folding_ranges` and `provide_code_actions` (quick fixes). for the Glyim compiler.
